const data = [
    ['Kévin', 'Monsieur', 'kevin.monsieur01@gmail.com', '&Y!m95', true],
    ['Martin', 'Neyns', 'martin.neyns.pro@gmail.com', '^22Wwv', true],
    ['Léon', 'Fashingabo', 'fashingaboleon@gmail.com', 'dP4%-N', true],
    ['Mohammad', 'Azad', 'mohammadazad.bc@gmail.com', ':tA5HL', true],
    ['Hanna', 'Masanjika', 'hanna.masanjika@gmail.com', '&Wz5=3', true],
    ['Victor', 'Tardif', 'victor.tardif1gmail.com', '?Gek9g', true],
