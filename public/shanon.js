...
if (date.getDay() == 3) {
  ...
  square[15].innerText= new Date(date.getTime() + 1036800000).toLocaleDateString('fr-FR', options);
  square[16].innerText= new Date(date.getTime() + 1123200000).toLocaleDateString('fr-FR', options);
...
if (date.getDay() == 2) {
  ...
  square[9].innerText= new Date(date.getTime() + 259200000).toLocaleDateString('fr-FR', options);//vendred 
